(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('axios'), require('date-fns'), require('escape-html'), require('jspdf'), require('jspdf-autotable'), require('@fortawesome/fontawesome-svg-core'), require('@fortawesome/vue-fontawesome')) :
	typeof define === 'function' && define.amd ? define(['exports', 'axios', 'date-fns', 'escape-html', 'jspdf', 'jspdf-autotable', '@fortawesome/fontawesome-svg-core', '@fortawesome/vue-fontawesome'], factory) :
	(factory((global.philaVueComps = {}),global.axios,global.dateFns,global.escapeHtml,global.jsPDF,global.jspdfAutotable,global.fontawesomeSvgCore,global.vueFontAwesome));
}(this, (function (exports,axios,dateFns,escapeHtml,jsPDF,jspdfAutotable,fontawesomeSvgCore,vueFontawesome) { 'use strict';
