<template>
  <div :class="checkboxClass">
    ...
    <legend-box v-if="this.$store.state.map.webMapActiveLayers.includes(layerName) && computedShouldShowLegendBox"
                :layer="layer"
                :layerName="layerName"
                :layerId="layerId"
    ...
    <slider v-if="this.$store.state.map.webMapActiveLayers.includes(layerName) && computedShouldShowSlider"
            :layer="layer"
            :layerName="layerName"
            :layerId="layerId"
            :opacity="opacity"
    ...
    <topic-component-group v-if="this.$store.state.map.webMapActiveLayers.includes(layerName)"
